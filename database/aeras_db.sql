...
CREATE TABLE `points` (
  ...
  `pullerid` varchar(256) DEFAULT NULL,
  `point` int DEFAULT NULL,
  `rideid` varchar(256) DEFAULT NULL,
  `date` varchar(20) DEFAULT NULL,
  `time` varchar(20) DEFAULT NULL,
  `flaged` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2025-11-13 18:32:07
